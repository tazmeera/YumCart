...
$(document).ready(function () {
  ...
  $(".menuBtn").click(function () {
    ...
    if ($(this)[0].className.search("plus") > -1) {
      count = count + 1;
      quantity.text(count);
      ToCart(foodNameClicked, count, singleFoodAmount); //is veg removed
      ...
      if (count <= 0) {
        ...
        count = count - 1;
        quantity.text(count);
        ToCart(foodNameClicked, count, singleFoodAmount); // isVeg, removed
      }
    }
  });

  function ToCart(foodNameClicked, foodQuantity,singleFoodAmount) { // isVeg, removed
    ...
    if (foodAlreadyThere) {
      ...
      food.push([foodNameClicked, foodQuantity, singleFoodAmount]); //, node removed
    } else {
      food.push([foodNameClicked, foodQuantity, singleFoodAmount]); //, node removed
    }
